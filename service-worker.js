...
const VERSION='1.27.57-dev-weekly-freeze-fix';
...
const SHELL=[
 ...
 './reels/reel-creator-v2.css','./reels/reel-safe-area-hotfix.css','./reels/reel-creator-v2.js','./reels/reel-schedule-manager.js','./reels/reel-voiceover.js','./reels/weekly-voiceover-script.js','./reels/reel-gemini-weekly.js','./reels/reel-quota-fallback.js','./reels/reel-copy-tools.js','./reels/reel-refresh-source-fix.js','./reels/reel-content-length-guard.js','./reels/reel-reflection-safe.js','./reels/weekly-reel-builder.js','./reels/reel-entry.js','./reels/mp4-result-panel.js','./reels/desktop-mp4-download-fix.js','./reels/native-mp4-recorder.js','./reels/browser-mp4.js',
