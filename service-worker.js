...
const VERSION='1.20.2-dev-social-fresh-type-routing';
const SHELL_CACHE=`de-mayo-shell-${VERSION}`;
const RUNTIME_CACHE=`de-mayo-runtime-${VERSION}`;
const OFFLINE_URL='./index.html';
const SHELL=[
 './','./index.html','./styles.css','./app.js','./analytics-config.js','./analytics-loader.js','./social-studio-history.js','./social-prayer-fresh.js','./sprint1-library.css','./sprint1-library.js','./sprint1-bible-workspace.css','./sprint1-bible-workspace.js','./unified-ai-creator.css','./unified-ai-creator.js','./ai-topic-scripture.js','./ai-scripture-intelligence.css','./ai-scripture-intelligence-fast.js','./ai-writing-assistant.css','./ai-writing-assistant.js',
