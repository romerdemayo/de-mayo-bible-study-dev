/* De Mayo Bible Studies — Reel sharing/copy tools restore v3 */
(function(){
'use strict';
...
function render(){
 ...
 if(!panel){
  ...
  $('#dmCopyReelCaptionHashtags').onclick=()=>copy(captionAndHashtags(current()),'Caption and hashtags');
