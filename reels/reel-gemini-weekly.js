...
function hashtagsText(item){const theme=clean($('#dmTheme')?.value||'hope').toLowerCase();const themeTags={hope:'#HopeInGod',faith:'#WalkByFaith',peace:'#PeaceInChrist',strength:'#GodIsMyStrength',gratitude:'#ThankfulToGod',courage:'#CourageInChrist',healing:'#HealingPrayer',guidance:'#GodsGuidance',protection:'#GodIsMyRefuge',anxiety:'#TrustGod',love:'#GodsLove',forgiveness:'#Forgiveness',trust:'#TrustGod',prayer:'#Prayer',joy:'#JoyInChrist',patience:'#WaitOnGod',wisdom:'#GodlyWisdom',family:'#ChristianFamily',relationships:'#ChristianRelationships',difficult:'#FaithInHardTimes',beginnings:'#NewBeginnings',purpose:'#GodsPurpose',provision:'#GodProvides',growth:'#SpiritualGrowth',fear:'#FaithOverFear',promises:'#GodsPromises'};const isMotivation=item?.contentType==='motivation'||contentType()==='motivation';const topic=isMotivation?'#ChristianMotivation':(themeTags[theme]||'#BibleEncouragement');return `${topic} #BibleVerse #Faith #DeMayoBibleStudies`;}
